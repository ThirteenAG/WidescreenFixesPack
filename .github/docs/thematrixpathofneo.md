...
<img src="https://thirteenag.github.io/screens/thematrixpathofneo/main2.jpg" width="760" alt="The Matrix: Path of Neo Widescreen Fix">

**The Matrix: Path of Neo Widescreen Fix** corrects resolution handling, aspect ratio, HUD scaling, field of view and video scaling for widescreen displays.

[Website](https://thirteenag.github.io/wfp#thematrixpathofneo) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/TheMatrixPathOfNeo.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/TheMatrixPathOfNeo.WidescreenFix/scripts/TheMatrixPathOfNeo.WidescreenFix.ini)
...
3. Optionally edit `scripts/TheMatrixPathOfNeo.WidescreenFix.ini` to configure the fix.
4. Launch the game.
