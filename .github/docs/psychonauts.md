...
<img src="https://thirteenag.github.io/screens/psychonauts/main2.jpg" width="760" alt="Psychonauts Widescreen Fix">

**Psychonauts Widescreen Fix** corrects widescreen HUD and video scaling.

[Website](https://thirteenag.github.io/wfp#psychonauts) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/Psychonauts.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/Psychonauts.WidescreenFix/scripts/Psychonauts.WidescreenFix.ini)
...
3. Optionally edit `scripts/Psychonauts.WidescreenFix.ini` to configure the fix.
4. Launch the game.
