...
<img src="https://thirteenag.github.io/screens/fireteambravo1/main2.jpg" width="760" alt="SOCOM: U.S. Navy SEALs Fireteam Bravo Fusion Fix (PPSSPP)">

**SOCOM: U.S. Navy SEALs Fireteam Bravo Fusion Fix (PPSSPP)** adds right-stick controls, intro skipping, and an option to speed up game loading.

[Website](https://thirteenag.github.io/wfp#fireteambravo1) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/SOCOM.FireteamBravo.PPSSPP.FusionFix/main.c) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/SOCOM.FireteamBravo.PPSSPP.FusionFix/memstick/PSP/PLUGINS/SOCOM.FireteamBravo.PPSSPP.FusionFix/SOCOM.FireteamBravo.PPSSPP.FusionFix.ini)
...
- **Dual analog controls** — Enable right-stick support.
...
2. Extract the archive into the directory containing PPSSPP’s `memstick` folder, preserving the folders in the archive.
3. Optionally edit `memstick/PSP/PLUGINS/SOCOM.FireteamBravo.PPSSPP.FusionFix/SOCOM.FireteamBravo.PPSSPP.FusionFix.ini` to configure the fix.
4. Launch the game in PPSSPP.
