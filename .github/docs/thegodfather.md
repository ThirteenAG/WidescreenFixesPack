...
<img src="https://thirteenag.github.io/screens/thegodfather/main2.jpg" width="760" alt="The Godfather Widescreen Fix">

**The Godfather Widescreen Fix** corrects resolution handling, HUD scaling and field of view for widescreen displays.

[Website](https://thirteenag.github.io/wfp#thegodfather) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/TheGodfather.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/TheGodfather.WidescreenFix/scripts/TheGodfather.WidescreenFix.ini)
...
3. Optionally edit `scripts/TheGodfather.WidescreenFix.ini` to configure the fix.
4. Launch the game.
