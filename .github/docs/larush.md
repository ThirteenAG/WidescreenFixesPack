...
<img src="https://thirteenag.github.io/screens/larush/main2.jpg" width="760" alt="L.A. Rush Widescreen Fix">

**L.A. Rush Widescreen Fix** corrects resolution handling, aspect ratio, HUD scaling, field of view and video scaling for widescreen displays.

[Website](https://thirteenag.github.io/wfp#larush) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/LARush.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/LARush.WidescreenFix/plugins/LARush.WidescreenFix.ini)
...
3. Optionally edit `plugins/LARush.WidescreenFix.ini` to configure the fix.
4. Launch the game.
