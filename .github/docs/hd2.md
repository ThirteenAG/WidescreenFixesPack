...
<img src="https://thirteenag.github.io/screens/hd2/main2.jpg" width="760" alt="Hidden &amp; Dangerous 2 Widescreen Fix">

**Hidden & Dangerous 2 Widescreen Fix** corrects widescreen scaling and field of view, with a configurable FOV multiplier. The incorrectly scaled damage overlay is disabled.

[Website](https://thirteenag.github.io/wfp#hd2) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/HiddenandDangerous2.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/HiddenandDangerous2.WidescreenFix/scripts/HiddenandDangerous2.WidescreenFix.ini)
...
- **Resolution** — Correct resolution handling for widescreen displays.
...
- **Damage overlay** — Damage overlay is disabled (not scaled properly)
...
3. Optionally edit `scripts/HiddenandDangerous2.WidescreenFix.ini` to configure the fix.
4. Launch the game.
