...
<img src="https://thirteenag.github.io/screens/sh4/main2.jpg" width="760" alt="Silent Hill 4: The Room Widescreen Fix">

**Silent Hill 4: The Room Widescreen Fix** corrects widescreen scaling and field of view, removes the 15 FPS cutscene limit, and offers startup and compatibility options.

[Website](https://thirteenag.github.io/wfp#sh4) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/SilentHill4.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/SilentHill4.WidescreenFix/scripts/SilentHill4.WidescreenFix.ini)
...
- **Videos** — Correct FMV scaling for widescreen. `Fix2D` also corrects menus, but disables some visual effects.

## Options

- **Cutscene borders** — Optionally remove cutscene letterboxing.
- **Pause background** — Render the pause background at native resolution.
- **Cutscene frame rate** — Remove the 15 FPS cutscene limit.
- **Registry** — Allow the game to run without its registry entries.
- **Safe mode** — Prevent the game from reverting to default settings after closing.
...
3. Optionally edit `scripts/SilentHill4.WidescreenFix.ini` to configure the fix.
4. Launch the game.
