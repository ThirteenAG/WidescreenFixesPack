...
<img src="https://thirteenag.github.io/screens/secondsight/main2.jpg" width="760" alt="Second Sight Widescreen Fix">

**Second Sight Widescreen Fix** corrects resolution handling, aspect ratio, HUD scaling and field of view for widescreen displays.

[Website](https://thirteenag.github.io/wfp#secondsight) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/SecondSight.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/SecondSight.WidescreenFix/scripts/SecondSight.WidescreenFix.ini)
...
- **Field of view** — Adjust the field of view for widescreen. A lower `FOVFactor` can hide some see-through-wall artifacts.
...
3. Optionally edit `scripts/SecondSight.WidescreenFix.ini` to configure the fix.
4. Launch the game.
