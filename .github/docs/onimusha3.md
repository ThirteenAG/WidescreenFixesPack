...
<img src="https://thirteenag.github.io/screens/onimusha3/main2.jpg" width="760" alt="Onimusha 3: Demon Siege Widescreen Fix">

**Onimusha 3: Demon Siege Widescreen Fix** corrects resolution handling, aspect ratio, HUD scaling, field of view and video scaling for widescreen displays.

[Website](https://thirteenag.github.io/wfp#onimusha3) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/Onimusha3.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/Onimusha3.WidescreenFix/scripts/Onimusha3.WidescreenFix.ini)
...
3. Optionally edit `scripts/Onimusha3.WidescreenFix.ini` to configure the fix.
4. Launch the game.
