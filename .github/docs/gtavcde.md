...
<img src="https://thirteenag.github.io/screens/gtavcde/main2.jpg" width="760" alt="Grand Theft Auto: Vice City: The Definitive Edition Fusion Fix">

**Grand Theft Auto: Vice City: The Definitive Edition Fusion Fix** adds HUD and radar scaling, F5 quicksaves, startup skips, and mouse camera adjustments, with an option to disable first-person rifle aiming.

[Website](https://thirteenag.github.io/wfp#gtavcde) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/GTAVCDE.FusionFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/GTAVCDE.FusionFix/Gameface/Binaries/Win64/scripts/GTAVCDE.FusionFix.ini)
...
- **Skip menu** — Skip the startup menu.
- **Quicksave** — Press F5 to save to the configured save slot.
- **HUD scale** — Adjust HUD and radar scaling in the INI file.
- **Mouse camera** — Corrected mouse camera movement.
- **Rifle aiming** — Optionally disable first-person aiming for rifles.
...
2. Extract the archive into the game’s installation folder, preserving its directory structure. The included files belong under `Gameface/Binaries/Win64`.
3. Optionally edit `Gameface/Binaries/Win64/scripts/GTAVCDE.FusionFix.ini` to configure the fix.
4. Launch the game.
