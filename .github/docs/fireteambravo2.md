...
<img src="https://thirteenag.github.io/screens/fireteambravo2/main2.jpg" width="760" alt="SOCOM: U.S. Navy SEALs Fireteam Bravo 2 Fusion Fix (PPSSPP)">

**SOCOM: U.S. Navy SEALs Fireteam Bravo 2 Fusion Fix (PPSSPP)** adds right-stick controls, intro skipping, and an option to speed up game loading.

[Website](https://thirteenag.github.io/wfp#fireteambravo2) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/SOCOM.FireteamBravo2.PPSSPP.FusionFix/main.c) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/SOCOM.FireteamBravo2.PPSSPP.FusionFix/memstick/PSP/PLUGINS/SOCOM.FireteamBravo2.PPSSPP.FusionFix/SOCOM.FireteamBravo2.PPSSPP.FusionFix.ini)
...
3. Optionally edit `memstick/PSP/PLUGINS/SOCOM.FireteamBravo2.PPSSPP.FusionFix/SOCOM.FireteamBravo2.PPSSPP.FusionFix.ini` to configure the fix.
