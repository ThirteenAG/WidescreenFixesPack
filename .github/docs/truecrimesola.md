...
<img src="https://thirteenag.github.io/screens/truecrimesola/main2.jpg" width="760" alt="True Crime: Streets of LA Widescreen Fix">

**True Crime: Streets of LA Widescreen Fix** corrects resolution handling, aspect ratio and field of view for widescreen displays.

[Website](https://thirteenag.github.io/wfp#truecrimesola) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/TrueCrimeStreetsofLA.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/TrueCrimeStreetsofLA.WidescreenFix/scripts/TrueCrimeStreetsofLA.WidescreenFix.ini)
...
3. Optionally edit `scripts/TrueCrimeStreetsofLA.WidescreenFix.ini` to configure the fix.
4. Launch the game.
