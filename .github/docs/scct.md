...
<img src="https://thirteenag.github.io/screens/scct/main2.jpg" width="760" alt="Splinter Cell: Chaos Theory Widescreen Fix">

**Splinter Cell: Chaos Theory Widescreen Fix** corrects widescreen scaling and field of view, adds raw mouse input and controller support, and restores EAX audio through DSOAL.

[Website](https://thirteenag.github.io/wfp#scct) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/SplinterCellChaosTheory.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/SplinterCellChaosTheory.WidescreenFix/System/scripts/SplinterCellChaosTheory.WidescreenFix.ini)
...
- **Saved settings** — Prevent settings from resetting on each launch.
- **Steam overlay** — Restore the Steam overlay when available.

## Options

- **Frame rate limit** — Limit FPS to reduce game bugs; the supplied INI uses 60 FPS.
- **Skip intro** — Skip startup intros.
- **Startup prompt** — Skip the “Press Any Key to Continue” screen.
...
2. Extract the archive into the game’s installation folder, preserving its directory structure. The included files belong under `System`.
3. Optionally edit `System/scripts/SplinterCellChaosTheory.WidescreenFix.ini` to configure the fix.
4. Launch the game.
