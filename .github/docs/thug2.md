...
<img src="https://thirteenag.github.io/screens/thug2/main2.jpg" width="760" alt="Tony Hawk&#x27;s Underground 2 Widescreen Fix">

**Tony Hawk's Underground 2 Widescreen Fix** corrects resolution handling, aspect ratio, HUD scaling, field of view and video scaling for widescreen displays.

[Website](https://thirteenag.github.io/wfp#thug2) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/TonyHawksUnderground2.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/TonyHawksUnderground2.WidescreenFix/Game/scripts/TonyHawksUnderground2.WidescreenFix.ini)
...
3. Optionally edit `Game/scripts/TonyHawksUnderground2.WidescreenFix.ini` to configure the fix.
4. Launch the game.
