...
<img src="https://thirteenag.github.io/screens/sh3/main2.jpg" width="760" alt="Silent Hill 3 Widescreen Fix">

**Silent Hill 3 Widescreen Fix** corrects widescreen scaling and field of view, with options for cutscene borders, video cropping, shadow resolution, and fog complexity.

[Website](https://thirteenag.github.io/wfp#sh3) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/SilentHill3.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/SilentHill3.WidescreenFix/scripts/SilentHill3.WidescreenFix.ini)
...
- **Effect resolution** — Configure dynamic shadow, status screen, and depth of field resolutions.

## Options

- **Fullscreen videos** — Optionally make FMVs fill the screen.
...
- **Fog** — Adjust fog complexity in the INI file.
...
3. Optionally edit `scripts/SilentHill3.WidescreenFix.ini` to configure the fix.
4. Launch the game.
