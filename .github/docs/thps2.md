...
<img src="https://thirteenag.github.io/screens/thps2/main2.jpg" width="760" alt="Tony Hawk&#x27;s Pro Skater 2 Widescreen Fix">

**Tony Hawk's Pro Skater 2 Widescreen Fix** corrects resolution handling, aspect ratio, HUD scaling, field of view and video scaling for widescreen displays.

[Website](https://thirteenag.github.io/wfp#thps2) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/TonyHawksProSkater2.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/TonyHawksProSkater2.WidescreenFix/scripts/TonyHawksProSkater2.WidescreenFix.ini)
...
3. Optionally edit `scripts/TonyHawksProSkater2.WidescreenFix.ini` to configure the fix.
4. Launch the game.
