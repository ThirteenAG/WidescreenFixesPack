...
<img src="https://thirteenag.github.io/screens/gun/main2.jpg" width="760" alt="GUN Widescreen Fix">

**GUN Widescreen Fix** corrects resolution handling, aspect ratio, HUD scaling and field of view for widescreen displays.

[Website](https://thirteenag.github.io/wfp#gun) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/Gun.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/Gun.WidescreenFix/scripts/Gun.WidescreenFix.ini)
...
3. Optionally edit `scripts/Gun.WidescreenFix.ini` to configure the fix.
4. Launch the game.
