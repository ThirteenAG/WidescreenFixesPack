...
<img src="https://thirteenag.github.io/screens/re5/main2.jpg" width="760" alt="Resident Evil 5 Fusion Fix">

**Resident Evil 5 Fusion Fix** fixes camera near clipping in co-op and adds borderless windowed mode and Logitech RGB lighting.

[Website](https://thirteenag.github.io/wfp#re5) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/ResidentEvil5.FusionFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/ResidentEvil5.FusionFix/scripts/ResidentEvil5.FusionFix.ini)
...
- **Co-op camera** — Correct near clipping that lets the camera see through walls.
...
3. Optionally edit `scripts/ResidentEvil5.FusionFix.ini` to configure the fix.
4. Launch the game.
