...
<img src="https://thirteenag.github.io/screens/thaw/main2.jpg" width="760" alt="Tony Hawk&#x27;s American Wasteland Widescreen Fix">

**Tony Hawk's American Wasteland Widescreen Fix** corrects resolution handling, aspect ratio, HUD scaling, field of view and video scaling for widescreen displays.

[Website](https://thirteenag.github.io/wfp#thaw) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/TonyHawksAmericanWasteland.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/TonyHawksAmericanWasteland.WidescreenFix/Game/scripts/TonyHawksAmericanWasteland.WidescreenFix.ini)
...
- **Soundtrack** — Randomize song order.
...
2. Extract the archive into the game’s installation folder, preserving its directory structure. The included files belong under `Game`.
3. Optionally edit `Game/scripts/TonyHawksAmericanWasteland.WidescreenFix.ini` to configure the fix.
4. Launch the game.
