...
<img src="https://thirteenag.github.io/screens/mp2/main2.jpg" width="760" alt="Max Payne 2: The Fall of Max Payne Widescreen Fix">

**Max Payne 2: The Fall of Max Payne Widescreen Fix** corrects widescreen HUD, field of view, and video scaling, with options for graphic novels, cutscene borders, and save loading.

[Website](https://thirteenag.github.io/wfp#mp2) · [Source Code](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/MaxPayne2.WidescreenFix/dllmain.cpp) · [Default INI](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/MaxPayne2.WidescreenFix/scripts/MaxPayne2.WidescreenFix.ini)
...
3. Optionally edit `scripts/MaxPayne2.WidescreenFix.ini` to configure the fix.
4. Launch the game.
