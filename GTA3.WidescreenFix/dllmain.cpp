...
void Init()
{
	...
	{
		if (injector::address_manager::singleton().GetMinorVersion() == 0)
		{
			injector::WriteMemory<uchar>(0x566A15, 0, true);
			injector::MakeNOP(0x566A56, 6, true);
			injector::MakeNOP(0x581C44, 2, true);
			injector::MakeNOP(0x581C52, 6, true);
