...
{
    uint32_t BeginPrimitive;
    uint32_t FArrayAlloc;
    void __fastcall DrawQuad(DWORD* _this, void* edx, float a2, float a3, float a4, float a5, int a6, float a7, float a8, float a9, float a10, int a11, float a12, float a13, float a14, float a15, int a16, float a17, float a18, float a19, float a20, int a21, int a22, int a23, float a24)
    {
        a2 /= Screen.fHudScale;
        ...
        injector::thiscall<uint32_t(DWORD*, int, int)>::call(BeginPrimitive, _this, 0, a23);
        ...
        auto v26 = injector::cstd<uint32_t(int, DWORD*)>::call(FArrayAlloc, 24, _this + 45);
        if (v26)
        {
            *(float*)(v26 + 0x00) = v40;
            *(float*)(v26 + 0x04) = v41;
        ...
        auto v27 = injector::cstd<uint32_t(int, DWORD*)>::call(FArrayAlloc, 24, _this + 45);
        if (v27)
        {
            *(float*)(v27 + 0x00) = v34;
            *(float*)(v27 + 0x04) = v35;
        ...
        auto v28 = injector::cstd<uint32_t(int, DWORD*)>::call(FArrayAlloc, 24, _this + 45);
        if (v28)
        {
            *(float*)(v28 + 0x00) = v37;
            *(float*)(v28 + 0x04) = v38;
        ...
        auto v29 = injector::cstd<uint32_t(int, DWORD*)>::call(FArrayAlloc, 24, _this + 45);
        if (v29)
        {
            *(float*)(v29 + 0x00) = v40;
            *(float*)(v29 + 0x04) = v41;
        ...
        auto v30 = injector::cstd<uint32_t(int, DWORD*)>::call(FArrayAlloc, 24, _this + 45);
        if (v30)
        {
            *(float*)(v30 + 0x00) = v37;
            *(float*)(v30 + 0x04) = v38;
        ...
        auto v31 = injector::cstd<uint32_t(int, DWORD*)>::call(FArrayAlloc, 24, _this + 45);
        if (v31)
        {
            *(float*)(v31 + 0x00) = v32;
            *(float*)(v31 + 0x04) = v33;
