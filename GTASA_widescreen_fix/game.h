...
struct SRwD3d9DisplayMode : SD3dDisplayMode {
	int m_iAdapter;
};

struct SRwD3d9DisplayModeEx : SD3dDisplayMode {
	int m_iDepth;
	int m_iAdapter;
};
...
#define ADDR_fScreenFieldOfView								0x008D5038
...
#define ADDR_pstGtaCamera									0x00C1703C
#define ADDR_clRsGlobal										0x00C17040
#define ADDR_clText											0x00C1B340
#define ADDR_fScreenAspectRatio								0x00C3EFA4
...
SRwD3d9DisplayMode	 **const VAR_ppastRwDisplayModeList					= (SRwD3d9DisplayMode			 **) ADDR_pastRwDisplayModeList;
int					  *const VAR_iRwNumAdapterDisplayModes				= (int							  *) ADDR_iRwNumAdapterDisplayModes;
SRwD3d9DisplayModeEx  *const VAR_pstRwAdapterDisplayMode				= (SRwD3d9DisplayModeEx			  *) ADDR_stRwAdapterDisplayMode;
...
bool				   (__cdecl		*const FUNC_rwDeviceSystemRequest				 ) (SRwDevice *pstDeviceInfo, ERwSysDevRequest eRequestId, void *pvInfo, void *pvHandle, int iIndex																					) = (bool					  (__cdecl		*) (SRwDevice *, ERwSysDevRequest, void *, void *, int										 )) ((0x007461AF + *(DWORD *)0x007461AB) - 0x0150);
int					   (__cdecl		*const FUNC_rwEngineGetNumVideoModes			 ) (																																												) = (int					  (__cdecl		*) (																						 )) (0x00745933 + *(DWORD *)0x0074592F);
SRwVideoMode		  *(__cdecl		*const FUNC_rwEngineGetVideoModeInfo			 ) (SRwVideoMode *pstModeInfo, int iModeIndex																																		) = (SRwVideoMode			 *(__cdecl		*) (SRwVideoMode *, int																		 )) GET_PTR_AT_OFFSET(FUNC_rwEngineGetNumVideoModes, 0x30);
int					   (__cdecl		*const FUNC_rwEngineGetCurrentVideoMode			 ) (																																												) = (int					  (__cdecl		*) (																						 )) GET_PTR_AT_OFFSET(FUNC_rwEngineGetVideoModeInfo, 0x30);
bool				   (__cdecl		*const FUNC_rwEngineSetVideoMode				 ) (int iModeIndex																																									) = (bool					  (__cdecl		*) (int																						 )) GET_PTR_AT_OFFSET(FUNC_rwEngineGetCurrentVideoMode, 0x30);
bool				   (__cdecl		*const FUNC_rwD3d9System						 ) (ERwSysDevRequest eRequestId, void *pvInfo, void *pvHandle, int iIndex																											) = (bool					  (__cdecl		*) (ERwSysDevRequest, void *, void *, int													 )) *(DWORD *)0x008E249C;
bool				   (__cdecl		*const FUNC_rwD3d9Release						 ) (ERwSysDevRequest eRequestId, void *pvInfo, void *pvHandle																														) = (bool					  (__cdecl		*) (ERwSysDevRequest, void *, void *														 )) (GET_PTR_AT_OFFSET(FUNC_rwD3d9System, 0x091E) + *(DWORD *)GET_PTR_AT_OFFSET(FUNC_rwD3d9System, 0x091A));
void				  *(__cdecl		*const PROC_rwD3d9CreateDisplayModeList			 ) (																																												) = (void					 *(__cdecl		*) (																						 )) (GET_PTR_AT_OFFSET(FUNC_rwD3d9System, 0x0177) + *(DWORD *)GET_PTR_AT_OFFSET(FUNC_rwD3d9System, 0x0173));
bool				   (__cdecl		*const FUNC_rwD3d9ChangeDisplayMode				 ) (int iModeIndex																																									) = (bool					  (__cdecl		*) (int																						 )) (0x00745C7A + *(DWORD *)0x00745C76);
// These functions may not be compatible with the latest version of themselves.
void				  *(__cdecl		*const FUNC_malloc								 ) (size_t tSize																																									) = (void					 *(_cdecl		*) (size_t																					 )) (0x0072F42A + *(DWORD *)0x0072F426);
void				   (__cdecl		*const PROC_free								 ) (void *pvMemoryPtr																																								) = (void					  (_cdecl		*) (void *																					 )) (0x0072F435 + *(DWORD *)0x0072F431);
void				  *(__cdecl		*const FUNC_realloc								 ) (void *pvMemoryPtr, size_t tSize																																					) = (void					 *(_cdecl		*) (void *, size_t																			 )) (0x0072F44F + *(DWORD *)0x0072F44B);
void				  *(__cdecl		*const FUNC_calloc								 ) (size_t tElements, size_t tSize																																					) = (void					 *(_cdecl		*) (size_t, size_t																			 )) (0x0072F46F + *(DWORD *)0x0072F46B);

DWORD				  *const JMP_OFF_0330_rwD3d9System					= (DWORD						  *) ((PBYTE)FUNC_rwD3d9System + 0x0330);
DWORD				  *const JMP_OFF_04F8_rwD3d9System					= (DWORD						  *) ((PBYTE)FUNC_rwD3d9System + 0x04F8);
DWORD				  *const JMP_OFF_0539_rwD3d9System					= (DWORD						  *) ((PBYTE)FUNC_rwD3d9System + 0x0539);
DWORD				  *const JMP_OFF_0AA0_rwD3d9System					= (DWORD						  *) ((PBYTE)FUNC_rwD3d9System + 0x0AA0);
DWORD				  *const JMP_OFF_09_rwD3d9Release					= (DWORD						  *) ((PBYTE)FUNC_rwD3d9Release + 0x09);
/*
