...
xcopy /S /Q /Y /F "textures/xquit.dds" "unpacked/8C37F6B1/PC_QUIT.dds"
...
xcopy /S /Q /Y /F "textures/select.dds" "unpacked/8C37F6B1/PC_CUSTOM.dds"
xcopy /S /Q /Y /F "textures/circle.dds" "unpacked/8C37F6B1/PC_BACK.dds"
xcopy /S /Q /Y /F "textures/pquit.dds" "unpacked/8C37F6B1/PC_QUIT.dds"
%XNFSTPKTool% -w2 unpacked/8C37F6B1.ini unpacked/temp1.tpk
...
xcopy /S /Q /Y /F "textures/select.dds" "unpacked/A8AD59C0/PC_CUSTOM.dds"
